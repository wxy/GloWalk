...
- **iOS** 15.0+
- **iPhone** — requires rear camera and LED flash · 需要后置摄像头和 LED 闪光灯
- **Xcode** 26+
...
- [Releases · 发布](https://github.com/wxy/GloWalk/releases)
- [Issues · 问题反馈](https://github.com/wxy/GloWalk/issues)
